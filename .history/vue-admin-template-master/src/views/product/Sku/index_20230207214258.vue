    ...
    <el-table style="width: 100%" :data="records" border>
      ...
      <el-table-column label="操作">
        <template slot-scope="{row}">
          ...
          <el-button type="info" icon="el-icon-top" size="mini" v-else @click="cencel(row)" title="下架"></el-button>
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="edit" title="编辑"></el-button>
          <el-button type="info" icon="el-icon-info" size="mini" title="查看详情"></el-button>
