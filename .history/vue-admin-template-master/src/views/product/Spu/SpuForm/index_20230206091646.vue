  ...
  <div>
    <el-form label-width="80px" :model="spu">
      ...
      <el-form-item label="销售属性">
        <el-select :placeholder="`${unSelectSaleAttr.length}` < 1 ? `还有${unSelectSaleAttr.length}个未选择` : '没有销售属性了><' " v-model="attrIdAndAttrName">
...
export default {
  ...
  methods: {
    ...
    async addOrUpdataSpu(){
      ...
      console.log(this.unSelectSaleAttr.length);
    }
  },
  computed:{
    // 计算出还未选择的销售属性
