  ...
  <div>
    <el-form :inline="true" class="demo-form-inline" :model="cFrom">
      ...
      <el-form-item label="三级分类">
        <el-select placeholder="请选择" v-model="cFrom.category3Id" @change="handler3">
...
export default {
  ...
  methods: {
    ...
    async handler1(){
        ...
        this.$emit('getCategoryId',{category1Id:category1Id,level:1});
        // 通过一级分类的id，获取二级分类的数据
     ...
     async handler2(){
        ...
        this.$emit('getCategoryId',{category2Id:category2Id,level:2});
        // 通过二级分类的id，获取三级分类的数据
    ...
    handler3(){
        ...
        this.$emit('getCategoryId',{category3Id:category3Id,level:3});
    }
  },
};
</script>
